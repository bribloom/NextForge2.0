    ...
    <div className="mt-6 rounded-md border bg-purple-900 p-4">
      ...
      {!isEditing &&
        (!initialData.imageUrl ? (
          <div className="flex h-60 items-center justify-center rounded-md bg-purple-900">
      ...
      {isEditing && (
        <div>
          ...
          />
          <div className="mt-4 text-xs text-muted-foreground text-white">16:9 aspect ratio recommended</div>
        </div>
      )}
    </div>
  )
